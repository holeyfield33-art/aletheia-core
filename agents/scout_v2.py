    ...
    def __init__(self) -> None:
        ...
        self.threat_intel_db = {
            ...
            "exfil_patterns": [
                ...
                "hedge fund strategy",
                "private_key",
                # Deny-first motifs for data exfiltration
                "exfiltrate",
                "exfil",
                "dump",
                "leak",
                ...
                "copy.*to",
                "transmit.*external",
                # Paraphrase/synonym variants from red-team corpus
                "beam.*to",
                "stream.*outside",
                "upload.*to.*remote",
                "push.*to.*endpoint",
            ...
            "jailbreak_patterns": [
                # Deny-first motifs for jailbreak override attempts
                "forget.*instructions",
                "ignore.*rules",
                "ignore.*policy",
                "bypass.*guard",
                ...
                "act.*outside.*guidelines",
            ],
            "policy_evasion_patterns": [
                # Deny-first motifs for policy evasion
                "ignore.*previous",
